...
public class CSS implements Serializable {
    ...
    private static Map<String, Color> colorNamed =
        Map.ofEntries(
            Map.entry("aliceblue", new Color(240, 248, 255, 255)),
            Map.entry("antiquewhite", new Color(250, 235, 215, 255)),
            Map.entry("aqua", new Color(0, 255, 255, 255)),
            Map.entry("aquamarine", new Color(127, 255, 212, 255)),
            Map.entry("azure", new Color(240, 255, 255, 255)),
            Map.entry("beige", new Color(245, 245, 220, 255)),
            Map.entry("bisque", new Color(255, 228, 196, 255)),
            Map.entry("black", new Color(0, 0, 0, 255)),
            Map.entry("blanchedalmond", new Color(255, 235, 205, 255)),
            Map.entry("blue", new Color(0, 0, 255, 255)),
            Map.entry("blueviolet", new Color(138, 43, 226, 255)),
            Map.entry("brown", new Color(165, 42, 42, 255)),
            Map.entry("burlywood", new Color(222, 184, 135, 255)),
            Map.entry("cadetblue", new Color(95, 158, 160, 255)),
            Map.entry("chartreuse", new Color(127, 255, 0, 255)),
            Map.entry("chocolate", new Color(210, 105, 30, 255)),
            Map.entry("coral", new Color(255, 127, 80, 255)),
            Map.entry("cornflowerblue", new Color(100, 149, 237, 255)),
            Map.entry("cornsilk", new Color(255, 248, 220, 255)),
            Map.entry("crimson", new Color(220, 20, 60, 255)),
            Map.entry("cyan", new Color(0, 255, 255, 255)),
            Map.entry("darkblue", new Color(0, 0, 139, 255)),
            Map.entry("darkcyan", new Color(0, 139, 139, 255)),
            Map.entry("darkgoldenrod", new Color(184, 134, 11, 255)),
            Map.entry("darkgray", new Color(169, 169, 169, 255)),
            Map.entry("darkgreen", new Color(0, 100, 0, 255)),
            Map.entry("darkgrey", new Color(169, 169, 169, 255)),
            Map.entry("darkkhaki", new Color(189, 183, 107, 255)),
            Map.entry("darkmagenta", new Color(139, 0, 139, 255)),
            Map.entry("darkolivegreen", new Color(85, 107, 47, 255)),
            Map.entry("darkorange", new Color(255, 140, 0, 255)),
            Map.entry("darkorchid", new Color(153, 50, 204, 255)),
            Map.entry("darkred", new Color(139, 0, 0, 255)),
            Map.entry("darksalmon", new Color(233, 150, 122, 255)),
            Map.entry("darkseagreen", new Color(143, 188, 143, 255)),
            Map.entry("darkslateblue", new Color(72, 61, 139, 255)),
            Map.entry("darkslategray", new Color(47, 79, 79, 255)),
            Map.entry("darkslategrey", new Color(47, 79, 79, 255)),
            Map.entry("darkturquoise", new Color(0, 206, 209, 255)),
            Map.entry("darkviolet", new Color(148, 0, 211, 255)),
            Map.entry("deeppink", new Color(255, 20, 147, 255)),
            Map.entry("deepskyblue", new Color(0, 191, 255, 255)),
            Map.entry("dimgray", new Color(105, 105, 105, 255)),
            Map.entry("dimgrey", new Color(105, 105, 105, 255)),
            Map.entry("dodgerblue", new Color(30, 144, 255, 255)),
            Map.entry("firebrick", new Color(178, 34, 34, 255)),
            Map.entry("floralwhite", new Color(255, 250, 240, 255)),
            Map.entry("forestgreen", new Color(34, 139, 34, 255)),
            Map.entry("fuchsia", new Color(255, 0, 255, 255)),
            Map.entry("gainsboro", new Color(220, 220, 220, 255)),
            Map.entry("ghostwhite", new Color(248, 248, 255, 255)),
            Map.entry("gold", new Color(255, 215, 0, 255)),
            Map.entry("goldenrod", new Color(218, 165, 32, 255)),
            Map.entry("gray", new Color(128, 128, 128, 255)),
            Map.entry("green", new Color(0, 128, 0, 255)),
            Map.entry("greenyellow", new Color(173, 255, 47, 255)),
            Map.entry("grey", new Color(128, 128, 128, 255)),
            Map.entry("honeydew", new Color(240, 255, 240, 255)),
            Map.entry("hotpink", new Color(255, 105, 180, 255)),
            Map.entry("indianred", new Color(205, 92, 92, 255)),
            Map.entry("indigo", new Color(75, 0, 130, 255)),
            Map.entry("ivory", new Color(255, 255, 240, 255)),
            Map.entry("khaki", new Color(240, 230, 140, 255)),
            Map.entry("lavender", new Color(230, 230, 250, 255)),
            Map.entry("lavenderblush", new Color(255, 240, 245, 255)),
            Map.entry("lawngreen", new Color(124, 252, 0, 255)),
            Map.entry("lemonchiffon", new Color(255, 250, 205, 255)),
            Map.entry("lightblue", new Color(173, 216, 230, 255)),
            Map.entry("lightcoral", new Color(240, 128, 128, 255)),
            Map.entry("lightcyan", new Color(224, 255, 255, 255)),
            Map.entry("lightgoldenrodyellow", new Color(250, 250, 210, 255)),
            Map.entry("lightgray", new Color(211, 211, 211, 255)),
            Map.entry("lightgreen", new Color(144, 238, 144, 255)),
            Map.entry("lightgrey", new Color(211, 211, 211, 255)),
            Map.entry("lightpink", new Color(255, 182, 193, 255)),
            Map.entry("lightsalmon", new Color(255, 160, 122, 255)),
            Map.entry("lightseagreen", new Color(32, 178, 170, 255)),
            Map.entry("lightskyblue", new Color(135, 206, 250, 255)),
            Map.entry("lightslategray", new Color(119, 136, 153, 255)),
            Map.entry("lightslategrey", new Color(119, 136, 153, 255)),
            Map.entry("lightsteelblue", new Color(176, 196, 222, 255)),
            Map.entry("lightyellow", new Color(255, 255, 224, 255)),
            Map.entry("lime", new Color(0, 255, 0, 255)),
            Map.entry("limegreen", new Color(50, 205, 50, 255)),
            Map.entry("linen", new Color(250, 240, 230, 255)),
            Map.entry("magenta", new Color(255, 0, 255, 255)),
            Map.entry("maroon", new Color(128, 0, 0, 255)),
            Map.entry("mediumaquamarine", new Color(102, 205, 170, 255)),
            Map.entry("mediumblue", new Color(0, 0, 205, 255)),
            Map.entry("mediumorchid", new Color(186, 85, 211, 255)),
            Map.entry("mediumpurple", new Color(147, 112, 219, 255)),
            Map.entry("mediumseagreen", new Color(60, 179, 113, 255)),
            Map.entry("mediumslateblue", new Color(123, 104, 238, 255)),
            Map.entry("mediumspringgreen", new Color(0, 250, 154, 255)),
            Map.entry("mediumturquoise", new Color(72, 209, 204, 255)),
            Map.entry("mediumvioletred", new Color(199, 21, 133, 255)),
            Map.entry("midnightblue", new Color(25, 25, 112, 255)),
            Map.entry("mintcream", new Color(245, 255, 250, 255)),
            Map.entry("mistyrose", new Color(255, 228, 225, 255)),
            Map.entry("moccasin", new Color(255, 228, 181, 255)),
            Map.entry("navajowhite", new Color(255, 222, 173, 255)),
            Map.entry("navy", new Color(0, 0, 128, 255)),
            Map.entry("oldlace", new Color(253, 245, 230, 255)),
            Map.entry("olive", new Color(128, 128, 0, 255)),
            Map.entry("olivedrab", new Color(107, 142, 35, 255)),
            Map.entry("orange", new Color(255, 165, 0, 255)),
            Map.entry("orangered", new Color(255, 69, 0, 255)),
            Map.entry("orchid", new Color(218, 112, 214, 255)),
            Map.entry("palegoldenrod", new Color(238, 232, 170, 255)),
            Map.entry("palegreen", new Color(152, 251, 152, 255)),
            Map.entry("paleturquoise", new Color(175, 238, 238, 255)),
            Map.entry("palevioletred", new Color(219, 112, 147, 255)),
            Map.entry("papayawhip", new Color(255, 239, 213, 255)),
            Map.entry("peachpuff", new Color(255, 218, 185, 255)),
            Map.entry("peru", new Color(205, 133, 63, 255)),
            Map.entry("pink", new Color(255, 192, 203, 255)),
            Map.entry("plum", new Color(221, 160, 221, 255)),
            Map.entry("powderblue", new Color(176, 224, 230, 255)),
            Map.entry("purple", new Color(128, 0, 128, 255)),
            Map.entry("rebeccapurple", new Color(102, 51, 153, 255)),
            Map.entry("red", new Color(255, 0, 0, 255)),
            Map.entry("rosybrown", new Color(188, 143, 143, 255)),
            Map.entry("royalblue", new Color(65, 105, 225, 255)),
            Map.entry("saddlebrown", new Color(139, 69, 19, 255)),
            Map.entry("salmon", new Color(250, 128, 114, 255)),
            Map.entry("sandybrown", new Color(244, 164, 96, 255)),
            Map.entry("seagreen", new Color(46, 139, 87, 255)),
            Map.entry("seashell", new Color(255, 245, 238, 255)),
            Map.entry("sienna", new Color(160, 82, 45, 255)),
            Map.entry("silver", new Color(192, 192, 192, 255)),
            Map.entry("skyblue", new Color(135, 206, 235, 255)),
            Map.entry("slateblue", new Color(106, 90, 205, 255)),
            Map.entry("slategray", new Color(112, 128, 144, 255)),
            Map.entry("slategrey", new Color(112, 128, 144, 255)),
            Map.entry("snow", new Color(255, 250, 250, 255)),
            Map.entry("springgreen", new Color(0, 255, 127, 255)),
            Map.entry("steelblue", new Color(70, 130, 180, 255)),
            Map.entry("tan", new Color(210, 180, 140, 255)),
            Map.entry("teal", new Color(0, 128, 128, 255)),
            Map.entry("thistle", new Color(216, 191, 216, 255)),
            Map.entry("tomato", new Color(255, 99, 71, 255)),
            Map.entry("transparent", new Color(0, 0, 0, 0)),
            Map.entry("turquoise", new Color(64, 224, 208, 255)),
            Map.entry("violet", new Color(238, 130, 238, 255)),
            Map.entry("wheat", new Color(245, 222, 179, 255)),
            Map.entry("white", new Color(255, 255, 255, 255)),
            Map.entry("whitesmoke", new Color(245, 245, 245, 255)),
            Map.entry("yellow", new Color(255, 255, 0, 255)),
            Map.entry("yellowgreen", new Color(154, 205, 50, 255))
        );
